...
description: !translate Aprende a potenciar tu flujo de trabajo de desarrollo con asistencia por línea de comandos impulsada por IA desde tu terminal.
...
🎯 [Lo que aprenderás](#lo-que-aprenderás) &ensp; ✅ [Requisitos](#requisitos) &ensp; 🤖 [Familia Copilot](#comprender-la-familia-github-copilot) &ensp; 📚 [Estructura del curso](#estructura-del-curso) &ensp; 📋 [Referencia de comandos](#referencia-de-comandos-de-github-copilot-cli)
...
GitHub Copilot CLI trae la asistencia de IA directamente a tu terminal. En lugar de cambiar a un navegador o editor de código, puedes hacer preguntas, generar aplicaciones completas, revisar código, generar pruebas y depurar problemas sin salir de tu línea de comandos.
...
- **Usuarios de terminal** que prefieren flujos de trabajo controlados por teclado en lugar de integraciones de IDE
- **Equipos que buscan estandarizar** prácticas de revisión de código asistida por IA y de desarrollo
...
| 02 | 🔍 [Contexto y conversaciones](./02-context-conversations/README.md) | Análisis de proyecto con múltiples archivos |
...
| 06 | 🔌 [Conectar a GitHub, Bases de datos & APIs](./06-mcp-servers/README.md) | Integración de servidor MCP |
...
- 🐛 **¿Encontraste un bug?** [Abrir un Issue](https://github.com/github/copilot-cli-for-beginners/issues)
...
2. Crea una rama de característica (`git checkout -b my-improvement`)
